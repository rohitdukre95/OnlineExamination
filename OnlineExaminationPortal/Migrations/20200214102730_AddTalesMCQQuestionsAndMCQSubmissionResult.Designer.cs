...
namespace OnlineExaminationPortal.Migrations
{
    ...
    [Migration("20200214102730_AddTalesMCQQuestionsAndMCQSubmissionResult")]
    partial class AddTalesMCQQuestionsAndMCQSubmissionResult
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineExaminationPortal.Models.Candidate", b =>
                {
                    ...
                    b.Property<int>("IsConsumed");

                    b.Property<int>("IsExamCleared");
            ...
            modelBuilder.Entity("OnlineExaminationPortal.Models.CandidateStatus", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CreatedBy = 1,
                            CreatedOn = new DateTime(2020, 2, 14, 15, 57, 30, 304, DateTimeKind.Local).AddTicks(2441),
                            IsActive = true,
                            LastUpdatedBy = 1,
                            LastUpdatedOn = new DateTime(2020, 2, 14, 15, 57, 30, 304, DateTimeKind.Local).AddTicks(7699),
                        ...
                        new
                        {
                            Id = 2,
                            CreatedBy = 1,
                            CreatedOn = new DateTime(2020, 2, 14, 15, 57, 30, 304, DateTimeKind.Local).AddTicks(8443),
                            IsActive = true,
                            LastUpdatedBy = 1,
                            LastUpdatedOn = new DateTime(2020, 2, 14, 15, 57, 30, 304, DateTimeKind.Local).AddTicks(8450),
                        ...
                        new
                        {
                            Id = 3,
                            CreatedBy = 1,
                            CreatedOn = new DateTime(2020, 2, 14, 15, 57, 30, 304, DateTimeKind.Local).AddTicks(8453),
                            IsActive = true,
                            LastUpdatedBy = 1,
                            LastUpdatedOn = new DateTime(2020, 2, 14, 15, 57, 30, 304, DateTimeKind.Local).AddTicks(8453),
                        ...
                        new
                        {
                            Id = 4,
                            CreatedBy = 1,
                            CreatedOn = new DateTime(2020, 2, 14, 15, 57, 30, 304, DateTimeKind.Local).AddTicks(8456),
                            IsActive = true,
                            LastUpdatedBy = 1,
                            LastUpdatedOn = new DateTime(2020, 2, 14, 15, 57, 30, 304, DateTimeKind.Local).AddTicks(8456),
            ...
            modelBuilder.Entity("OnlineExaminationPortal.Models.MCQQuestions", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("OnlineExaminationPortal.Models.MCQSubmissionResult", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
